...
<head>
    ...
    <title>Belajar Mandiri di Rumah.</title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href=''>Abdul Rochim.</a></div>
            <div class="menu">
                <ul>
    ...
    <div class="wrapper">
        ...
        <section id="home">
            ...
            <div class="kolom">
                <p class="deskripsi">Belajar Mandiri #dirumahaja</p>
    ...
    <div id="contact">
        <div class="wrapper">
            <div class="footer">
                ...
                <div class="footer-section">
                    <h3>Contact</h3>
                    <p>Jl. Magelang 4,5 Sleman Yogyakarta</p>
                    <p>Kode Pos: 57365</p>
                </div>
                <div class="footer-section">
                    <h3>Social</h3>
                    <p><b>YouTube: </b>Belajar Mandiri Bersama Abdul Rochim</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="copyright">
        <div class="wrapper">
            &copy; 2020. <b>Abdul Rochim.</b> All Rights Reserved.
        </div>
    </div>
